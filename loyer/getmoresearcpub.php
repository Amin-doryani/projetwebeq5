...
$myoffset = $_GET['myvar'];
$thecity = $_GET['myvar1'];
$minprice = $_GET['myvar2'];
$maxprice = $_GET['myvar3'];

$sql = "SELECT id,title,idC,prix,ville FROM publication where ville = '$thecity' and prix > $minprice and prix < $maxprice  limit 12 OFFSET $myoffset";
